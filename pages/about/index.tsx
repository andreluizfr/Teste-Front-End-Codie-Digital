  ...
  return (
    <>
      ...
      <Main>
        ...
        <TitleText>O Centro Pokémon</TitleText>

        <SubtitleText>Como funciona a cura de um pokémon?</SubtitleText>
        <Text>
        ...
        <SubtitleText>Uma tradição de mais de 20 anos</SubtitleText>
        <Text>
        ...
        <SubtitleText>O melhor para seu pokémon</SubtitleText>
        <Text>
        ...
        <SubtitleText>Alta Tecnologia</SubtitleText>
        <Text>
